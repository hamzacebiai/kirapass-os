/**
 * Partner domain/application errors (local to this module). Mapped to HTTP
 * status by the controller. Shared-kernel consolidation is intentionally
 * deferred (premature abstraction); duplication is accepted at this stage.
 */
